...
```{r}
print(head(list.files("train-jpg")))
print(length(list.files("train-jpg")))
```
...
library(tidyverse)
library(stringr)
train_labels <- read_csv("train.csv")
...
temp <- brick('train-jpg/train_1.jpg')
dim(values(temp))
...
X_list <- pblapply(list.files('train-jpg'), function(a) {
  img <- brick(paste("train-jpg", a, sep = "/"))
